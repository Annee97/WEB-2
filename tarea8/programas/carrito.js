...
function mostrarMenu() {
    ...
    do {
        ...
        switch (opcion) {
            ...
            case "2":
                carrito.push("Pantalón - $500");
                total += 500;
                alert("Pantalón añadido al carrito de compra.");
                break;

            case "3":
                carrito.push("Zapatos - $800");
                total += 800;
                alert("Zapatos añadidos al carrito de compra.");
                break;

            case "4":
                carrito.push("Sombrero - $200");
                total += 200;
                alert("Sombrero añadido al carrito de compra.");
                break;
